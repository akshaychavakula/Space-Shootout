...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ContrastEnhance : PostEffectsBase
	{
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
		{
            ...
            RenderTexture color4a = RenderTexture.GetTemporary (rtW/1, rtH/1, 0);
            ...
            RenderTexture color4b = RenderTexture.GetTemporary (rtW/1, rtH/1, 0);
            ...
            color4a = RenderTexture.GetTemporary (rtW/1, rtH/1, 0);
