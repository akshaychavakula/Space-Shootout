...
namespace Opsive.UltimateCharacterController.Editor.Managers
{
    ...
    public class ItemManager : Manager
    {
        ...
        private void DrawNewItem()
        {
            ...
            if (m_ActionType != ItemBuilder.ActionType.Shield && m_ActionType != ItemBuilder.ActionType.MagicItem && m_ActionType != ItemBuilder.ActionType.Flashlight) {
                EditorGUI.indentLevel++;
        ...
        private void DrawExistingItem()
        {
            ...
            if (m_AddActionType != ItemBuilder.ActionType.Shield && m_AddActionType != ItemBuilder.ActionType.MagicItem && m_AddActionType != ItemBuilder.ActionType.Flashlight) {
                EditorGUI.indentLevel++;
