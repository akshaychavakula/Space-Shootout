...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class Drive : DetectObjectAbilityBase
    {
        ...
        [Tooltip("Can the Drive ability use items?")]
        [SerializeField] protected bool m_CanUseItems;
        ...
        public bool CanUseItems { get => m_CanUseItems; set => m_CanUseItems = value; }
        ...
        private AbilityStartLocation GetValidStartLocation(bool groundCheck)
        {
            // At least one ability start location must be on the ground and not obstructed by any object.
            var startLocations = m_DriveSource.GameObject.GetComponentsInChildren<AbilityStartLocation>();
        ...
        {
            return m_DriveSource.GameObject.GetComponentsInChildren<AbilityStartLocation>();
        }
        ...
        {
            return !m_CanUseItems && startingAbility is Items.ItemAbility;
        }
        ...
        public override void UpdateRotation()
        {
            ...
            if (m_DriveState != DriveState.Drive && !m_TeleportEnterExit) {
        ...
        public override void WillTryStopAbility()
        {
            ...
            AbilityStartLocation startLocation;
            ...
            if (m_TeleportEnterExit) {
                OnExitedVehicle();
                m_CharacterLocomotion.SetPositionAndRotation(startLocation.transform.position, startLocation.transform.rotation, true, false);
            }
        }
