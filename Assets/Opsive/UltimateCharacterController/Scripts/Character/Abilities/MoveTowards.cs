    ...
    public class MoveTowards : Ability
    {
        ...
        protected override void AbilityStarted()
        {
            ...
            if (m_PathfindingMovement != null && m_PathfindingMovement.Index < Index) {
                m_PathfindingMovement.SetDestination(m_StartLocation.GetTargetPosition());
            }
        ...
        {
            // ItemEquipVerifier and ItemAbilities should never be blocked.
            if (startingAbility is ItemEquipVerifier || startingAbility is Items.ItemAbility) {
                return false;
            }
            ...
            return startingAbility.Index > Index || startingAbility is StoredInputAbilityBase;
        }
        ...
        public override void Update()
        {
            ...
            if (!m_StartLocation.IsPositionValid(m_Transform.position, m_Transform.rotation, m_CharacterLocomotion.Grounded)) {
                ...
                arrived = false;
            } else if (!m_StartLocation.PrecisionStart && (m_PathfindingMovement == null || !m_PathfindingMovement.IsActive) && 
