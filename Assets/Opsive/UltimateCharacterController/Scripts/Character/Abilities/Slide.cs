...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class Slide : Ability
    {
        ...
        public override void UpdatePosition()
        {
            ...
            var direction = Vector3.Cross(Vector3.Cross(groundRaycastHitNormal, -m_CharacterLocomotion.Up), groundRaycastHitNormal);
            var horizontalMotorThrottle = Vector3.ProjectOnPlane(m_CharacterLocomotion.MotorThrottle, m_CharacterLocomotion.Up);
            var horizontalDirection = Vector3.ProjectOnPlane(direction, m_CharacterLocomotion.Up);
