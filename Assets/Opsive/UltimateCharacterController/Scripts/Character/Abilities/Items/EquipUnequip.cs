    ...
    public class EquipUnequip : ItemSetAbilityBase
    {
        ...
        public void WillStartPickup()
        {
            ...
            for (int i = 0; i < allItems.Count; ++i) {
                // A duplicate item will exist if the item shares ItemIdentifiers.
        ...
        private void OnPickupItem(Item item, int amount, bool immediatePickup, bool forceEquip)
        {
            ...
            if (!m_ItemSetManager.IsCategoryMember(item.ItemIdentifier.GetItemDefinition(), m_ItemSetCategoryIndex) || !Enabled) {
                return;
            }
                    ...
                    if (immediatePickup && (forceEquip || m_ActiveItemSetIndex == -1 || itemSetIndex < m_ActiveItemSetIndex)) {
                        ...
                        for (int i = 0; i < m_Inventory.SlotCount; ++i) {
                            ...
                            if (m_ItemSetManager.IsCategoryMember(itemIdentifier.GetItemDefinition(), m_ItemSetCategoryIndex)) {
                                ...
                                var equipItem = m_Inventory.GetItem(i, itemIdentifier);
                                if (equipItem != null) {
                                    equipItem.WillEquip();
        ...
        /// </summary>
        /// <param name="itemIdentifier">The ItemIdentifier that may be equipped.</param>
        ...
        /// <summary>
        /// Can the specified ItemIdentifier be equipped? An ability may prevent it from being equipped.
        /// </summary>
        /// <param name="itemSetIndex">The index of the ItemSet that is being equipped.</param>
        /// <param name="itemIdentifier">The ItemIdentifier of the item that is trying to be equipped.</param>
            ...
            if (m_StartEquipUnequip) {
                ...
                for (int i = 0; i < m_Inventory.SlotCount; ++i) {
                    ...
                    if (currentItemIdentifier != null) {
                        currentItem = m_Inventory.GetItem(i, currentItemIdentifier);
                    }
                    ...
                    if (targetItemIdentifier != null && m_Inventory.GetItemIdentifierAmount(targetItemIdentifier) > 0) {
                        targetItem = m_Inventory.GetItem(i, targetItemIdentifier);
                    }
            ...
            if (m_EquipItems[slotID] != null || m_UnequipItems[slotID] != null) {
                ...
                if (!startUnequip && m_UnequipItems[slotID] != null) {
                    if (m_UnequippingItems[slotID] && startAbility) {
                        ...
                        if (m_ItemSetManager.GetEquipItemIdentifier(m_ItemSetCategoryIndex, m_ActiveItemSetIndex, slotID) == m_UnequipItems[slotID].ItemIdentifier) {
        ...
        {
            if (m_ItemSetManager.IsCategoryMember(item.ItemIdentifier.GetItemDefinition(), m_ItemSetCategoryIndex)) {
