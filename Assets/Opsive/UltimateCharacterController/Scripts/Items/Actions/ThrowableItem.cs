...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public class ThrowableItem : UsableItem
    {
        ...
        protected override void Awake()
        {
            ...
            // ItemTypes act as both definitions and identifiers.
            if (m_ConsumableItemDefinition is ItemType) {
                m_ConsumableItemIdentifier = m_ConsumableItemDefinition as ItemType;
            }
        ...
        public override bool CanUseItem(ItemAbility itemAbility, UseAbilityState abilityState)
        {
            ...
            if (m_Inventory != null && m_Inventory.GetItemIdentifierAmount(m_ConsumableItemIdentifier) == 0) {
                return false;
            }
        ...
        public override void UseItem()
        {
            ...
            ThrowItem();
            if (m_Inventory != null) {
                m_Inventory.AdjustItemIdentifierAmount(m_ConsumableItemIdentifier, -1);
            }
            m_Thrown = true;
        }
        ...
        public override void ItemUseComplete()
        {
            ...
            if (!m_DisableVisibleObject && m_Inventory.GetItemIdentifierAmount(m_ConsumableItemIdentifier) > 0) {
                m_Reequipping = true;
