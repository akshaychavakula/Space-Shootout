...
namespace Opsive.UltimateCharacterController.Objects.CharacterAssist
{
    ...
    public class AbilityStartLocation : MonoBehaviour
    {
        ...
        /// <summary>
        /// Returns the target position of the Ability Start Location.
        /// </summary>
        /// <returns>The target position of the Ability Start Location.</returns>
        public Vector3 GetTargetPosition()
        {
            return m_Transform.TransformPoint(m_Offset);
        }
